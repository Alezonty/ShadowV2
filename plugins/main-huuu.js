...
conn.sendImageAsSticker(m.chat, pickRandom(stikerhuuu), m, { packname: "© ShadowBotz", author: "Rez" })
}

handler.customPrefix = /^(huuu|kontol|anjing|memek|babi|Reza|bot|Oh Bot|Damz)$/i
